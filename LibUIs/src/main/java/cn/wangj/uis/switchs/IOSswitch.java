...
import cn.wangj.uis.R;

/**
 * IOS风格的Switch<p>
 * 方法1，自定义控件（TODO 本类尚未完善，无setEnable()方法）；<p>
 * 方法2：定制drawable资源改变原生Switch外观，见selector_switch_track和selector_switch_thumb
 */
public class IOSswitch extends View {
    ...
    private IOSswitch(Context context) {
        super(context);
    }
    ...
    public void setup(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.IOSswitch);
        offBorderColor = typedArray.getColor(R.styleable.IOSswitch_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.IOSswitch_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.IOSswitch_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.IOSswitch_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.IOSswitch_borderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.IOSswitch_animate, defaultAnimate);
        typedArray.recycle();
    ...
    public void setOnColor(String colorStr) {
        this.onColor = Color.parseColor(colorStr);
        invalidate();
    }

    public void setOffBorderColor(String colorStr) {
        this.offBorderColor = Color.parseColor(colorStr);
        borderColor = offBorderColor;
        invalidate();
    }

    public void setOffColor(String colorStr) {
        this.offColor = Color.parseColor(colorStr);
        invalidate();
    }

    public void setSpotColor(String colorStr) {
        this.spotColor = Color.parseColor(colorStr);
        invalidate();
    }
}
